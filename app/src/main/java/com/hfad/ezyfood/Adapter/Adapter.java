...
import com.hfad.ezyfood.Menu.MyOrder;
...
public class Adapter extends BaseAdapter {
    ...
    public Adapter(Context cont, ArrayList<Item> item) {
        this.cont = cont;
        this.item = item;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = LayoutInflater.from(cont).inflate(R.layout.activity_listof_item,parent,false);
        }
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                item.remove(remove);
                Intent intent = new Intent(cont, MyOrder.class);
